...
namespace MassTransit
{
    ...
    public static class TelemetryConfigurationExtensions
    {
        ...
        public static ConnectHandle ConnectSendTelemetryObservers<T>(this T connector, ITelemetryClient client, ISendMetadataFactory metadataFactory = null,
            ...
            where T : ISendObserverConnector, IPublishObserverConnector
        {
            ...
            var sendHandle = connector.ConnectSendObserver(new TelemetrySendObserver(client, factory, specification.Filter));
            var publishHandle = connector.ConnectPublishObserver(new TelemetryPublishObserver(client, factory, specification.Filter));

            return new MultipleConnectHandle(publishHandle);
        }
        ...
        ///// <param name="configureFilter">Filter configuration delegate</param>
        ///// <param name="metadataFactory">Message metadata factory. If omited, the default one will be used.</param>
        //public static ConnectHandle ConnectConsumeTelemetryObserver(this IConsumeObserverConnector connector, IMessageAuditStore store,
